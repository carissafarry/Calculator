...
public class CalculatorView extends javax.swing.JFrame {
    ...
    public CalculatorView() {
        ...
        jRadioButton1.setEnabled(false);  // matikan tombol ON
    }
    ...
    public void enable(){
        ...
        jRadioButton1.setEnabled(false);  // matikan tombol ON
        jRadioButton2.setEnabled(true);  // nyalakan tombol OFF
    ...
    public void disable(){
        ...
        jRadioButton1.setEnabled(true);  // nyalakan tombol ON
        jRadioButton2.setEnabled(false);  // matikan tombol OFF
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(length > 0){
            // buat instance StringBuilder kosong untuk manipulasi isi dari text field
            StringBuilder back = new StringBuilder(jTextField1.getText());
            
            // hapus 1 karakter pada posisi array ke-number setelah text berhasil didapatkan
            back.deleteCharAt(number);
            
            // ubah nilai yang telah dimanipulasi ke dalam bentuk string biasa,
            // karena TextField hanya menerima nilai string
            store = back.toString();
            
            // simpan ke dalam text field
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // === menampilkan nilai input operator pada label, bukan pada text field ===

        // konversi string nilai dari text field ke double, simpan ke num
        num = Double.parseDouble(jTextField1.getText());
        
        // set switch ke case penambahan
        calculation = 2;
        
        // hapus text field setelah operasi aritmatika dilakukan
        jTextField1.setText("");
        
        // tampilkan input operator pada label
        jLabel1.setText(num + "-");
    ...
    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        enable();  // panggil fungsi enable pada tombol ON
    } 
    
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        disable();  // panggil fungsi disable pada tombol OFF
    } 
